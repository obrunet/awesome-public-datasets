...
This repo has been forked from https://github.com/awesomedata/awesome-public-datasets and improved or personnalized.
...
* |OK_ICON| `U.S. Department of Agriculture's PLANTS Database <https://plants.sc.egov.usda.gov/java/>`_
...
* |OK_ICON| `Seshat Global History Databank <http://seshatdatabank.info/>`_
...
* |OK_ICON| `The Dataverse Project <https://dataverse.org/#>`_

* |OK_ICON| `Opendata Monitor <https://opendatamonitor.eu/frontend/web/index.php?r=dashboard%2Findex>`_

* |OK_ICON| `Plenar.io <http://plenar.io/>`_

* |OK_ICON| `Open Data Impact Map - A public database of organizations that use open data from around the world. <https://opendataimpactmap.org/>`_

* |OK_ICON| `Data.world <https://data.world/>`_

* |OK_ICON| `Quandl -  financial, economic, and alternative datasets <https://www.quandl.com//>`_

* |OK_ICON| `Google Scholar <https://scholar.google.com/>`_

* |OK_ICON| `Big Query Public Datasets <https://cloud.google.com/bigquery/public-data/>`_

* |OK_ICON| `Data.Is Plural <https://tinyletter.com/data-is-plural/>`_

* |OK_ICON| `Open Data Network <https://www.opendatanetwork.com/>`_

* |OK_ICON| `Visual Data - Computer Vision Datasets<https://www.visualdata.io/>`_
